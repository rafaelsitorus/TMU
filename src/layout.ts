...
<div class="min-h-screen bg-[#080808] text-white">
  ...
  <!-- ── Desktop sidebar ── -->
  <aside class="hidden lg:flex flex-col fixed inset-y-0 left-0 w-80 xl:w-[360px] z-20 bg-[#080808] border-r border-white/[0.06] px-8 py-8 overflow-y-auto">
    ...
    <div class="pt-6 mt-auto border-t border-white/[0.06]">
      ...
      <a href="/contact.html" class="inline-block px-5 py-2 bg-blue-600 hover:bg-blue-500 rounded-lg text-[11px] font-medium tracking-wider uppercase transition-colors">Contact Us</a>
    </div>
  </aside>

  <!-- ── Mobile header ── -->
  <header class="lg:hidden sticky top-0 z-30 bg-[#080808]/95 backdrop-blur-md border-b border-white/[0.06]">
  ...
  <div id="mob-drawer" class="fixed inset-0 z-40 hidden lg:hidden">
    ...
    <div class="absolute right-0 inset-y-0 w-64 bg-[#0e0e0e] p-6 flex flex-col shadow-2xl">
      ...
      ${mobileLinks}
      <a href="/contact.html" class="mt-6 block text-center px-4 py-2.5 bg-blue-600 rounded-lg text-[11px] font-medium tracking-wider uppercase transition-colors hover:bg-blue-500">Contact Us</a>
    </div>
  </div>
