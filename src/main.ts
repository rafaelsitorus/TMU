...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  ...
  <div id="home-root" class="flex flex-col relative">
    ...
    <section id="company-header" class="company-header-section">
      ...
      <img src="/landing_image.png" alt="" aria-hidden="true" class="hero-bg-img">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            ...
            <div class="group bg-[var(--nav-bg)] border border-[var(--border-subtle)] rounded-2xl overflow-hidden transition-all duration-300 hover:border-[var(--border-light)] hover:-translate-y-1 hover:shadow-2xl md:col-span-2 lg:col-span-3 flex flex-col md:flex-row">
              <div class="relative w-full md:w-2/5 h-64 md:h-auto overflow-hidden">
                <img src="/card4.png" alt="Data Center" class="w-full h-full object-cover object-center transition-transform duration-700 group-hover:scale-105">
      ...
      <div class="max-w-7xl mx-auto px-6 md:px-10 py-14 md:py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-14">
          ...
          <div>
            ...
            <div class="space-y-4">
              <div>
                ...
                <a href="tel:0215655080" class="text-sm text-white/60 hover:text-white transition-colors">021-5655080 / 81</a>
              </div>
              <div>
                <span class="text-[10px] tracking-[0.15em] text-white/30 uppercase block mb-1">Email</span>
                <a href="mailto:todomitrautama@yahoo.co.id" class="text-sm text-white/60 hover:text-white transition-colors">todomitrautama@yahoo.co.id / adm@todomitrautama.com</a>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p class="text-sm text-white/40 leading-relaxed mb-4">Jl. Daan Mogot 45 A/5 RT 010 RW 003,Jelambar, Grogol Petamburan, Jakarta Barat<br>DKI Jakarta, Indonesia</p>
            <div>
              <span class="text-[10px] tracking-[0.15em] text-white/30 uppercase block mb-1">Jam Operasional</span>
              <p class="text-sm text-white/40">Senin – Sabtu: 08.00 – 17.00</p>
            </div>
          </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-5">
            <a href="mailto:todomitrautama@yahoo.co.id" class="text-white/25 hover:text-white/70 transition-colors">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            </a>
            <a href="tel:0215655080" class="text-white/25 hover:text-white/70 transition-colors">
...
document.querySelectorAll('.plx-from-left, .plx-from-right, .plx-from-bottom').forEach(el => {
